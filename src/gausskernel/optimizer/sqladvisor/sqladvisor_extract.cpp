...
#ifdef GS_GRAPH
static List* extractNodeNestLoopVLE(Plan* plan, List* ancestors, List* rtable, List* subplans)
{
    List* resSubplan = NIL;
    NestLoopVLE* nestLoopVLE = (NestLoopVLE*)plan;        
    extractQual(nestLoopVLE->nl.join.joinqual, plan, ancestors, rtable, subplans);
    resSubplan = extractSubplan((Expr*)nestLoopVLE->nl.join.plan.targetlist, resSubplan, subplans);
    resSubplan = extractSubplan((Expr*)nestLoopVLE->nl.join.plan.qual, resSubplan, subplans);
    resSubplan = extractSubplan((Expr*)nestLoopVLE->nl.join.joinqual, resSubplan, subplans);
    return resSubplan;
}
#endif
...
#ifdef GS_GRAPH
        case T_NestLoopVLE: {
            resSubplan = extractNodeNestLoopVLE(plan, ancestors, rtable, subplans);
        } break;
#endif
        case T_VecMergeJoin: {
