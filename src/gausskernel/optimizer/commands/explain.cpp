...
#ifdef GS_GRAPH
        case T_NestLoopVLE: {
			NestLoopVLE* nestLoop = (NestLoopVLE*)plan;
            if (nestLoop->nl.join.optimizable) {
                ...
                show_upper_qual(((NestLoopVLE*)plan)->nl.join.joinqual, "Join Filter", planstate, ancestors, es);
            }
