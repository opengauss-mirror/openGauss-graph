...
PG_KEYWORD("algo", ALGO, RESERVED_KEYWORD)
PG_KEYWORD("algob", ALGOB, RESERVED_KEYWORD)
PG_KEYWORD("algod", ALGOD, RESERVED_KEYWORD)
PG_KEYWORD("algos", ALGOS, RESERVED_KEYWORD)
...
PG_KEYWORD("breathfs", BREATHFS, RESERVED_KEYWORD)
...
PG_KEYWORD("degree", DEGREE, RESERVED_KEYWORD)
...
PG_KEYWORD("edge_table", EDGE_TABLE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("end_node", END_NODE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("isiri", ISIRI, RESERVED_KEYWORD)
PG_KEYWORD("isliteral", ISLITERAL, RESERVED_KEYWORD)
PG_KEYWORD("isnull", ISNULL, UNRESERVED_KEYWORD)
PG_KEYWORD("isnumeric", ISNUMERIC, RESERVED_KEYWORD)
PG_KEYWORD("isolation", ISOLATION, UNRESERVED_KEYWORD)
PG_KEYWORD("isuri", ISURI, RESERVED_KEYWORD)
...
#endif
PG_KEYWORD("node_table", NODE_TABLE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("pagerank", PAGERANK, RESERVED_KEYWORD)
...
PG_KEYWORD("regex", REGEX, RESERVED_KEYWORD)
...
PG_KEYWORD("shortestpath", SHORTESTPATH, RESERVED_KEYWORD)
...
PG_KEYWORD("sparql", SPARQL, UNRESERVED_KEYWORD)
PG_KEYWORD("spill", SPILL, UNRESERVED_KEYWORD)
PG_KEYWORD("split", SPLIT, UNRESERVED_KEYWORD)
PG_KEYWORD("src_node", SRC_NODE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("tsquery", TSQUERY, RESERVED_KEYWORD)
PG_KEYWORD("tsvector", TSVECTOR, RESERVED_KEYWORD)
