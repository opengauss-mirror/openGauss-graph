...
// DATA(insert OID = 4038 (403 	jsonb_path_ops	PGNSP PGUID ));
...
DATA(insert OID =       5 (4439       text_pattern_ops    PGNSP PGUID));
...
DATA(insert OID = 8193 (  403 graphid_ops           PGNSP PGUID ));
#define GRAPHID_BTREE_FAM_OID 8193
DATA(insert OID = 8196 (  405 graphid_ops           PGNSP PGUID ));
DATA(insert OID = 8198 ( 2742 graphid_ops           PGNSP PGUID ));
// DATA(insert OID = 8205 ( 3580 graphid_minmax_ops    PGNSP PGUID ));

DATA(insert OID = 8267 (  403 rowid_ops             PGNSP PGUID ));
