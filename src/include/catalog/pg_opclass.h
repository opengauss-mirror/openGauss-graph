...
// DATA(insert ( 403	  jsonb_path_ops   PGNSP    PGUID  4038  3802 f 23 ));
DATA(insert ( 2742    jsonb_hash_ops   PGNSP    PGUID  4037  3802 f 23 ));

#ifdef GS_GRAPH
DATA(insert (  403 graphid_ops          PGNSP PGUID 8193 8102 t 0 ));
DATA(insert (  405 graphid_ops          PGNSP PGUID 8196 8102 t 0 ));
DATA(insert ( 2742 graphid_ops          PGNSP PGUID 8198 8102 t 0 ));
// DATA(insert ( 3580 graphid_minmax_ops   PGNSP PGUID 8205 8102 t 0 ));

DATA(insert (  403 rowid_ops          	PGNSP PGUID 8267 8162 t 0 ));
#endif /* GS_GRAPH */
