...
// DATA(insert (	4038   3802 3802 1 351 ));
// DATA(insert (	4038   3802 3802 2 3485 ));
// DATA(insert (	4038   3802 3802 3 3486 ));
// DATA(insert (	4038   3802 3802 4 3487 ));
// DATA(insert (	4038   3802 3802 6 3489 ));
/* hash */
 ...
 */
/* BTree */
DATA(insert ( 8193 8102 8102  1 8194 ));
/* Hash */
DATA(insert ( 8196 8102 8102  1 8197 ));
/* GIN (as BTree) */
DATA(insert ( 8198 8102 8102  1 8194 ));
DATA(insert ( 8198 8102 8102  2 8200 ));
DATA(insert ( 8198 8102 8102  3 8201 ));
DATA(insert ( 8198 8102 8102  4 8202 ));
DATA(insert ( 8198 8102 8102  5 8203 ));

// /* BRIN (minmax) */
// DATA(insert ( 8205 8102 8102  1 3383 ));
// DATA(insert ( 8205 8102 8102  2 3384 ));
// DATA(insert ( 8205 8102 8102  3 3385 ));
// DATA(insert ( 8205 8102 8102  4 3386 ));

/*
 * rowid_ops
 */
/* BTree */
DATA(insert ( 8267 8162 8162  1 8268 ));
