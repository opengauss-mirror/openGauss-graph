...
#ifdef GS_GRAPH
/* Functions to set up gs_graphmeta for metric */
extern void gsstat_count_edge_create(Graphid edge, Graphid start, Graphid end);
extern void gsstat_count_edge_delete(Graphid edge, Graphid start, Graphid end);
extern void gsstat_drop_vlabel(const char *vlab);
extern void gsstat_drop_elabel(const char *elab);
extern void gsstat_drop_graph(const char *graph);
